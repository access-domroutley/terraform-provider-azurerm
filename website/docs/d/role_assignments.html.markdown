...
Use this data source to access information about existing Role Assignments at a specified scope.
...
* `principal_id` - The principal ID to filter the list of Role Assignments against.
